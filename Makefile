a.ptc: a.ptc.txt txt2ptc.py
	python3 txt2ptc.py $< $@
	cp $@ '/Users/user/.local/share/citra-emu/sdmc/Nintendo 3DS/00000000000000000000000000000000/00000000000000000000000000000000/extdata/00000000/00001172/user/###/TA.OUT'
